...
Since we are given that elections in PA are not fair.  Then  PA state house rep is obligated to take actions that ensure elections are fair.  (WAIT!!! Is becuase a state pa house is obigated to take action,,,,  well could go into more detail later).  This means fixing the reason (the counter example) that is causing elections to not be fair. 
...
I need to show: that there are a sequence of actions that can be taken to change the current unfair elections into fair ones in the future. 





A PA state house is obligated take actions that ensure fair elections.
